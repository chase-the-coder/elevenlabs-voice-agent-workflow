...
- After loading, check current git branch and ElevenLabs state
...
4. **Read and present**
   ...
   - Also run `git status` and `git branch` to show current state
...
001-2026-02-10-lindsays-hvac-relocation.md
002-2026-02-12-prompt-optimization.md  <- Most Recent

To load a specific handoff: /pickup 1
